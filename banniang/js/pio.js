    ...
    /* - 提示操作 */
        ...
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["你问我为什么有两只羊角？咩啊！但是你可以羡慕我，嘿嘿~","华南马聚总有你喜欢的东西，让我来带你玩儿！","哼，不要随便碰我的衣服，我知道它很酷，这是我大老远跑去瑞瑞那让她设计的呢！","我很喜欢音乐，不管是民间小马创作的歌曲，还是谐律元素们传唱的歌曲，都超棒的！","夏天的羊城好热啊，不过和小马们在一起的时光总是开心的。","想和我面对面交流吗，7.19~21在羊城等你 *Boop*","我知道我很酷，不过我不介意有小马夸我（移开视线）","咩","感谢各位对华南马聚的支持，咩咩都看在眼里~","咩啊？"]);
            };
        },
        // 右侧按钮
         buttons: function () {
