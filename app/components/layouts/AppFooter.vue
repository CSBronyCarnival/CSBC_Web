...
const friendLinks = [
  ...
  { id: 'kp', href: 'http://suncelebration.butterpony.com/', src: '/img/link/exchange/kp_b.png', hoverSrc: '/img/link/exchange/kp.png' },
  { id: 'epona', href: 'https://x.com/Poniko_MLP/', src: '/img/link/exchange/epona_b.png', hoverSrc: '/img/link/exchange/epona.png' },
