...
const friendLinks = [
  ...
  { id: 'kp', href: 'https://vk.ru/katushiny_posidelki/', src: '/img/link/exchange/kp_b.png', hoverSrc: '/img/link/exchange/kp.png' },
  { id: 'epona', href: 'https://eponafest.it/', src: '/img/link/exchange/epona_b.png', hoverSrc: '/img/link/exchange/epona.png' },
